...
<body>
		...
		<div id="wrapper">
			...
			<div id="main">
				...
				<!--		Email :<input type="email" name="data1" value="" required />
						Password :<input type="password" name="data1" value="" required /> -->
					<!--	<input type="submit" value="log-in" style="height=100px; width=720px"/>
						<input type="submit" value="sign-up"style="height=100px; width=720px"/> -->
